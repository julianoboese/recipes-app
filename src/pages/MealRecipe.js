  ...
  return (
    <main>
      ...
      <button
        ...
        onClick={ () => navigator.clipboard.writeText(`http://localhost:3000${location.pathname}`) }
      >
        <img src={ shareIcon } alt="icone para compartilhar" />
      </button>

      <button type="button" data-testid="favorite-btn">
        <img src={ favoriteIcon } alt="coração para favoritar" />
      </button>
      ...
      <RecomendCarousel recomendations={ objToCarousel } />
